...
//This function is kept aside for the moment, we don't see the real utility 
    /**
    ...
    */
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) internal {
        ...
        //_ownedTokens[to][length].push(tokenId);
    ...
    function _mint(address to, uint tokenId) internal override(ERC721) {
        ...
        //THESE ARE NOW IN THE BEFORETOKENTRANSFER FUNCTION
        //_addTokenToAllTokensEnumeration(tokenId);
        //_addTokenToOwnerEnumeration(to, tokenId);
    }
